...
test('K toggles between cinematic realism and anime',()=>{
 ...
 assert.equal(body.dataset.visualStyle,'realistic');
...
test('skybox retains anime atmosphere as the alternate style',()=>{
